<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage_eBooks.master" AutoEventWireup="false" CodeFile="Thailand_and_Regional.aspx.vb" Inherits="Thailand_and_Regional" %>
<%@ Register Src="uc/ucPromotion_eBooks.ascx" TagName="ucPromotion_eBooks" TagPrefix="uc1" %>
<%@ Register Assembly="MycustomDG" Namespace="MycustomDG" TagPrefix="Saifi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="h1_content">Vast Selection of eBooks on
      Thailand and Regional
    Interest</td>
  </tr>
  <tr>
    <td class="f12_arial" style="padding-top:5px">The largest collection of ebooks on 
      Thailand and Regional Interest are 
    available for your selection</td>
  </tr>
</table>
<br />
