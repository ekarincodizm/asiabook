<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage_eBooks.master" AutoEventWireup="false" CodeFile="Best_Value.aspx.vb" Inherits="Best_Value" %>
<%@ Register Src="uc/ucPromotion_eBooks.ascx" TagName="ucPromotion_eBooks" TagPrefix="uc1" %>
<%@ Register Assembly="MycustomDG" Namespace="MycustomDG" TagPrefix="Saifi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="h1_content">The Best Value for International eBooks</td>
  </tr>
  <tr>
    <td class="f12_arial" style="padding-top:5px">We offer the best value for money by giving you the great books at the reasonable possible price. Our half a million titles are with price ranges from less than 100 Baht.</td>
  </tr>
</table>
<br />
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="bg_dot_line">&nbsp;</td>
  </tr>
   <tr>
    <td>
    ...
    <td style="width: 90%" align="center">
        ...
        <tr>
            ...
            <td style="width: 201px" align="right" valign="top">
                <uc1:ucPromotion_eBooks ID="ucPromotion_eBooks1" runat="server" /></td>
        </tr>
        </table></td>
</tr>
<tr>
