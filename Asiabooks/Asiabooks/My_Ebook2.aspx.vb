...
Partial Class MyEbook2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack And Not Me.IsCallback Then
            If MyEBookID <> "-1" Then
                download()
            Else
                Label_Status.Text = "Duplicate downloading"
            End If
        End If
    End Sub
    ...
    Private Sub download()
        ...
        GenerateLog("MyEbook2_Download", "", "", OrderNo, "", "", "https://www.asiabooks.com", "", "download in MyEbook2")

        Try
            Dim sqlCommand As String

            sqlCommand = "SELECT distinct MyEBookID, e.bookid, e.isbn_13, e.book_title, t.Type, isnull(l.supplier_code, e.supplier_code) as supplier_code, e.max_download, Downloaded_Times, Download_URL, l.Order_No, l.Order_No_Tx, isnull(o.Customer_Country, 'ZZ') as Customer_Country, od.Unitprice "
            ...
            If dt.Rows.Count > 0 Then
                ...
                Label_eBook.Text = "Title: " + dt.Rows(0).Item("book_title") + " ( " + dt.Rows(0).Item("Type") + " )"
                Label_Status.Text = "Please wait until the download panel appears on your screen."

                Frame_Download.Attributes("src") = dt.Rows(0).Item("Download_URL").ToString
                ...
                If dt.Rows(0).Item("supplier_code").ToString.Trim.ToLower.Equals("gardners") Then
                    ...
                    '    GenerateLog("EmailToGardners", "", "", OrderNo, "", "", "https://www.asiabooks.com", "", ex.Message.ToString & " - " & ex.GetBaseException.ToString)
                    'End Try
            ...
            Else
                Frame_Download.Attributes("src") = ""
                ScriptManager.RegisterClientScriptBlock(Me.Page, Me.GetType, "Alert", "alert('Your download credit is not enough for this eBook.'); window.location.href = 'My_Ebook.aspx';", True)
            End If

        Catch ex As Exception
            GenerateLog("MyEbook2_Download", "", "", OrderNo, "", "", "https://www.asiabooks.com", "", ex.Message.ToString)
            Throw ex
        End Try
    ...
    Public Function LogDownload(ByVal BookID As String, ByVal OrderNo As String, ByVal Selling_Price As String, ByVal Country_Code As String, ByVal Status As String, ByVal UserAgent As String, ByVal MyEBookID As String) As Boolean
        Try
            ...
            Catch ex As Exception
                SqlDb.RollbackTrans()
                PN.GenerateLog("My_EBook2_LogDownload", "", "", OrderNo, "", "", "https://www.asiabooks.com", "", ex.Message.ToString)
