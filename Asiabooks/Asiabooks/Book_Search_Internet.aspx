<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Book_Search_Internet.aspx.vb" Inherits="Book_Search_Internet" title="Untitled Page" %>
...
<tr>
    <td style="width: 100%"><asp:Label ID="Label_Result" runat="server" CssClass="grdBestseller_detail" /><asp:Label ID="lblPage_Name" 
        runat="server" Visible="False" /><asp:Label ID="lblResult" runat="server" Visible="False" /></td>
</tr>
<tr>
