<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Customer_Information_Internet.aspx.vb" Inherits="Customer_Information_Internet" title="Untitled Page" %>
...
<tr>
    <td style="width: 100%" align="left">
        <asp:Image ID="Imageshopping_step_03" runat="server" ImageUrl="~/images/Shopping_Step/shopping_step_03.gif" /></td>
</tr>
<tr>
                ...
                <tr>
                    ...
                    <td align="center" valign="top">
                        ...
                        <tr>
                            ...
                            <td style="width: 60%; height: 29px;" class="font_other" align="left"><asp:LinkButton ID="lnkPopup" runat="server" 
                                Font-Names="arial" Font-Size="9pt" ForeColor="#666666">Forgot Password</asp:LinkButton>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 60%; height: 167px;">
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 40%; ">
                    ...
                    <td align="center" valign="top" >
                        ...
                        <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td style="width: 40%; height: 58px;">
                                    </td>
                                    <td style="width: 60%; height: 58px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 40%">
