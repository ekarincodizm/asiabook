<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Book_Search_Author.aspx.vb" Inherits="Book_Search_Author" title="Untitled Page" %>
...
<tr>
    <td style="width: 100%"><asp:Label ID="Label_Result" runat="server" CssClass="grdBestseller_detail" />
        <asp:Label ID="lblAuthor_Name" 
                        ...
                        <asp:TemplateColumn>
                            <itemtemplate>
                                ...
                                <tr>
                                    ...
                                    <asp:Image style="VERTICAL-ALIGN: top" id="Book_Image" runat="server" 
                                    ImageUrl='<%# Eval("image") %>' Width="85px" CssClass="Grid_bookItem_image" Height="126px" __designer:wfdid="w362"></asp:Image></a></td>
                            ...
                            <itemtemplate>
                                ...
                                <br />
                                    <asp:LinkButton ID="lnkavailable" runat="server" CssClass="grdBestseller_head" 
                                        ForeColor="Red" Visible="False">Available On Other Format</asp:LinkButton>&nbsp;
                                    ...
                                    <td style="width: 100px" align="left" valign="top">
                                        ...
                                        <tr>
                                            <td style="width: 119px; height:69px" valign="top" align="right">
                                                ...
                                                <asp:Label ID="lblYour_Price_D" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                                    ForeColor="#006600" Text='<%# Eval("selling_price_eComN","{0:#,###}") %>' /><br />
                                                <asp:Label ID="lblSave_Price_L" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                                    ForeColor="#404040" Text='(Save ' />
                                                <asp:Label ID="lblSave_Price_C" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                                    ForeColor="#404040" Text='<%# Eval("eCom_discount","{0:#,###}") %>' />
                                                 <asp:Label ID="lblSave_Price_R" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 119px; height:25px" valign="bottom"><a style="text-decoration:none;" 
                                                href='book_detail_Internet.aspx?Title_1=<%# Eval("ISBN_13") %>&Book_type=<%# Eval("Book_type") %>'><asp:Image ID="ImageButton1" 
                                                runat="server" ImageUrl="~/images/Template/add_to_cart.jpg" /></a></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 119px; height:25px" align="right" valign="bottom"><asp:ImageButton 
