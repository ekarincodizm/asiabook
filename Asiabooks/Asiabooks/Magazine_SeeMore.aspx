<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Magazine_SeeMore.aspx.vb" Inherits="Magazine_SeeMore" title="Untitled Page" %>
            ...
            <td valign="top">
                <Saifi:MyDg ID="Datagrid" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                            ...
                            <itemtemplate>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="top" > <a href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("ISBN_13") %>'>
                                        <asp:Image id="Image9" runat="server" ImageUrl='<%# Eval("image") %>' Width="85px"  Height="126px" __designer:wfdid="w362"></asp:Image></a></td>
                        ...
                        <asp:TemplateColumn>
                            <itemtemplate>
                                <BR /><a style="text-decoration:none;" href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("ISBN_13") %>'>
                                ...
                                <asp:Label id="Label1" 
                                    ...
                                    __designer:wfdid="w367" Text="Editon : "></asp:Label><asp:Label id="lblauthor" runat="server" 
                                    ...
                                    Text="Issue : "></asp:Label><asp:Label id="Label13" runat="server" CssClass="grdBestseller_detail" 
                                        ...
                                        <td style="width: 100px" align="left" valign="top">
                                            ...
                                            <tr>
                                                <td style="width: 119px; height:69px" valign="top" align="right">
                                                    ...
                                                    <asp:Label ID="lblSave_Price" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                                        ForeColor="#404040" Text='<%# Eval("price_save") %>' /><br />
                                            ...
                                            <tr>
                                                <td align="right" style="width: 119px; height:25px" valign="bottom"><a style="text-decoration:none;" 
                                                    href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("ISBN_13") %>'><asp:Image ID="ImageButton1" 
