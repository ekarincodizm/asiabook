<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucMagazine.ascx.vb" Inherits="uc_ucMagazine" %>
    ...
    <ItemTemplate>
        <li>
            ...
            <tr>
                ...
                <td align="center" valign="top" ><a href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("isbn_13")%>' ><img src='<%# Eval("image")%>' alt=""/></a></td>
            ...
            <div class="book-title">
                <a style="text-decoration:none;" class="book-title" href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("isbn_13")%>' rel="add-to-cart">
                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("book_title")%>' ToolTip='<%#Eval("book_title_full")%>'></asp:Label></a></div>
            <div class="book-author">
                <a style="text-decoration:none;" class="book-author" href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("isbn_13")%>'>
            ...
            <a href='Magazine_Detail_Internet.aspx?Title_1=<%# Eval("isbn_13")%>' rel="add-to-cart"><asp:Image runat="server" ID="imgAddToCart" ImageUrl="~/images/Template/add_to_cart.jpg" style="border:0;" class="add-to-cart-button" /></a>
