<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucTop5_Magazine.ascx.vb" Inherits="uc_ucTop5_Magazine" %>
                ...
                <ItemTemplate>
                    ...
                    <tr valign="top">
                        ...
                        <td align="left" width="60%">
                            <a style="text-decoration:none;" href='Magazine_Detail_Internet.aspx?Title_1=<%# DataBinder.Eval(Container, "DataItem.ISBN_13") %>'>
                        ...
                        <td align="left" valign="middle" width="20%"><a style="text-decoration:none;" 
                            href='Magazine_Detail_Internet.aspx?Title_1=<%# DataBinder.Eval(Container, "DataItem.ISBN_13") %>'>
