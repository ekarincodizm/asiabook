<%@ Control Language="VB" AutoEventWireup="true" CodeFile="Country.ascx.vb" Inherits="uc_PopEmp" %>
<table cellpadding="0" cellspacing="0" style="width: 1px; height: 1px">
    <tr>
        <td style="width: 120px; height: 21px;">
            <asp:DropDownList ID="cboEmp" runat="server" Font-Names="MS Sans Serif" Font-Size="10pt" Width="130px">
            </asp:DropDownList></td>
    ...
    <table width="100%" style="border-right: darkgray 2px solid; border-top: darkgray 2px solid; border-left: darkgray 2px solid; border-bottom: darkgray 2px solid; background-color: gainsboro">
        <tr>
            <td style="width: 330px; text-align: center">
                <asp:Label ID="Label2" runat="server" Text="Search Country" Width="200px" Font-Bold="True" Font-Names="Verdana" Font-Size="11pt"></asp:Label></td>
            <td style="width: 3px">
            </td>
            <td style="width: 3px">
        ...
        <tr>
            <td style="width: 87px; height: 24px;">
                <asp:DropDownList ID="ddlSearch" runat="server" Width="93px" Font-Names="MS Sans Serif" Font-Size="10pt">
                    ...
                    <asp:ListItem Value="0">Country Code</asp:ListItem>
                    <asp:ListItem Value="1">Country Name</asp:ListItem>
                </asp:DropDownList></td>
                     ...
                     <asp:TemplateField>
                            <ItemTemplate>
                                <asp:TextBox ID="tbxID" runat="server" BorderStyle="None" Style="background-color: transparent; cursor: hand; color: #0099ff; text-decoration: underline;"
                                    Width="100px" Text = '<%#DataBinder.Eval(Container.DataItem,"Country_Code")%>'  ReadOnly="True" Font-Names="Tahoma" Font-Size="8pt"></asp:TextBox>
                            </ItemTemplate>
                            <HeaderTemplate>
                                Country code
                            </HeaderTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:TextBox ID="tbxName" runat="server" BorderStyle="None" Style="background-color: transparent"
                                    Width="185px" Text = '<%#DataBinder.Eval(Container.DataItem,"Country_Name")%>' ReadOnly="True" Font-Names="Tahoma" Font-Size="8pt" ></asp:TextBox>
                            </ItemTemplate>
                            <HeaderTemplate>
                                ountry Name
                            </HeaderTemplate>
